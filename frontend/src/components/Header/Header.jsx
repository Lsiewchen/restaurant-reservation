  ...
  return (
    <Box>
      <AppBar position="fixed" sx={{ bgcolor: '#FFFFFF' }}>
        <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', height:110 }}>
            <Box sx={{ justifyContent: 'left', width: 90, height: 'auto' }} component="img" src={logo} />
            <Box sx={{ width: '60%', height: '100%' }}>
                <Typography variant="h6" noWrap component="div"
                sx={{ py: 1.5, display: {xs: 'none', sm: 'block'}, textAlign: 'center', fontSize: 26, fontWeight: 'bold', color: '#000000b3' }}
                >
